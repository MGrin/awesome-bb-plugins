...
- [bb-sentry-issues](https://github.com/MacHatter1/bb-sentry-issues) — read-only Sentry issue browser for bounded issue snapshots across configured projects, with severity summaries, searchable issue details, and optional links to local BB triage threads.
